...
|Gaurav | Did the Prework part, completed various exercises of ML crash course while doing probability sidewise | Read the documentation of Pytorch, TensorFlow, NumPy, image processing course, Kaggle deep learning course, and read the paper. 
