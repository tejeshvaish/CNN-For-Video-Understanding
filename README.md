...
| Nikita  | Did the pre-work, probability-stats course and completed ML crash course and it's colab exercises | Completed Image Recognition course and from kaggle, did the image processing, computer vision and deep learning exercises and contributed to literature review, ppt and Documentation|  |Content Cell  |
